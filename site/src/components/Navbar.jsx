    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-5">
      ...
      >
        ...
        <div className="flex justify-end items-center gap-2 shrink-0">
          <Link to="/chat" className="hidden md:inline-flex items-center gap-1.5 text-[14px] font-medium text-white/70 hover:text-white px-3 py-2 rounded-lg hover:bg-white/[0.08] transition-colors">
            <span className="w-1.5 h-1.5 bg-accent rounded-full pulse-ring text-accent" /> AI Chat
          </Link>
          <a href="/#contact" className="hidden md:inline-flex items-center gap-1.5 rounded-lg bg-accent text-white px-4 py-2 text-[14px] font-semibold hover:bg-accent-ink transition-colors">
            Get free audit
        ...
        {/* mobile toggle */}
        <button onClick={() => setOpen(!open)} className="md:hidden text-white p-2 justify-self-end" aria-label="Toggle menu">
